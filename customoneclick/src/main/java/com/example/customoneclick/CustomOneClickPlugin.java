...
import com.example.customoneclick.comparables.skilling.Spell;
...
//            event.setOpcode(event.getOpcode() + MENU_ACTION_DEPRIORITIZE_OFFSET);
//        }
    ...
    private void updateConfig()
    {
        ...
        switch (type)
        {
            ...
            case CUSTOM:
                ...
                comparable.setClient(client);
                comparable.setPlugin(this);
                ((Custom) comparable).updateMap(config.itemSwaps());
                break;
            case KARAMBWANS:
                comparable = type.getComparable();
                comparable.setClient(client);
                comparable.setPlugin(this);
                ((Karambwans) comparable).updateMap(config.objectSwaps());
            default:
                comparable = type.getComparable();
                comparable.setClient(client);
                comparable.setPlugin(this);
